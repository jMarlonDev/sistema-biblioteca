...
public class LibrarianManagementView extends JPanel {
    ...
    private void initFormPanel() {
        ...
        leftWrapper.setPreferredSize(new Dimension(350, 0)); // Mantenemos el ancho original de 350px
    ...
    private void initTablePanel() {
        ...
        tableLibrarians = new JTable(tableModel);
        JScrollPane scrollPane = new JScrollPane(tableLibrarians);
    ...
    public JTable getTableLibrarians() {
        return tableLibrarians;
    }
